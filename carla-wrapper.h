...
static inline void param_index_to_name(uint32_t index,
...
static inline void remove_all_props(obs_properties_t *props,
				    obs_data_t *settings)
{
...
void carla_priv_process_audio(struct carla_priv *carla, float *buffers[2],
			      uint32_t frames);
