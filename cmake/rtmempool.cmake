...
target_compile_definitions(carla_rtmempool PUBLIC
  REAL_BUILD
)

target_include_directories(carla_rtmempool PUBLIC
  carla/source/includes
  carla/source/utils
)

target_link_libraries(carla_rtmempool PUBLIC
  ${CMAKE_THREAD_LIBS_INIT}
  ${carla_rtmempool_extra_libs}
)

target_sources(carla_rtmempool PUBLIC
